      ...
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="flex flex-col items-start z-20">
          ...
          >
            ...
            <span className="text-white/80 text-[10px] sm:text-xs font-bold tracking-[0.25em] uppercase">
          ...
          >
            We bring expert, transparent, and ultra-fast appliance repair
            directly to your doorstep. Backed by a flawless 90-day warranty.
          </motion.p>
          ...
          >
            <a
              href="#contact"
              className="group flex items-center justify-center gap-3 px-10 py-4 bg-white text-black rounded-full font-bold text-xs uppercase tracking-widest transition-all hover:bg-secondary-yellow hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.1)]"
            >
              Book Service{" "}
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 px-10 py-4 rounded-full border border-white/20 text-white font-bold text-xs uppercase tracking-widest hover:bg-white/10 transition-colors"
            >
        ...
        <div className="relative w-full aspect-square max-w-[550px] mx-auto flex items-center justify-center z-10 mt-16 lg:mt-0">
          ...
          >
            ...
            <img
              ...
              alt="AC Technician"
              className="w-full h-full object-cover scale-110 group-hover:scale-125 transition-transform duration-[15s] opacity-90"
            />
          ...
          >
            <span className="text-secondary-yellow font-black text-sm">
              ⭐ 4.9
            </span>
            <span className="text-white/60 text-[10px] font-bold tracking-widest uppercase border-l border-white/20 pl-3">
              Top Rated
            </span>
          </motion.div>
        </div>
